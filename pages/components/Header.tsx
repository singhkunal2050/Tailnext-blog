  ...
  return (
    <header>
      <nav className="border-2 border-b-black bg-blue-200 ">
        <div className="mx-auto  flex items-center max-w-5xl  justify-between  py-4">
          <div className="z-30">
            <Link href={'/'}>
          ...
          <div
            className={
              ...
              ' flex min-h-full min-w-full list-none flex-col items-center justify-center gap-4 bg-white  transition duration-500  ease-in-out md:static md:min-w-min md:translate-x-0 md:flex-row md:gap-4 md:bg-blue-200'
            }
          >
          ...
          <div
            className="nav-toggle z-30 px-5 md:hidden"
