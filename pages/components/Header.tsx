  ...
  return (
    <header>
      <nav className="border-2 border-b-black bg-blue-200 ">
        <div className="mx-auto  flex max-w-5xl  justify-between py-4">
          <div className="z-30">
            <Link href={'/'}>
              <svg viewBox="0 0 3940 610" class="w-40">
          ...
          <div
            className={
              'fixed inset-0 z-0 ' + (!isOpen && "translate-x-[-100%]") + ' flex min-h-full min-w-full list-none flex-col items-center justify-center gap-4 bg-white md:static md:translate-x-0 md:flex-row  md:gap-4 md:bg-blue-200 transition duration-500 ease-in-out'
            } 
          >
            ...
            <li className="rounded-3xl bg-black p-2 text-white">
              <Link href={'/'}> Get Started</Link>
            </li>
          </div>
          <div className="nav-toggle z-30 px-5 md:hidden" onClick={()=>setIsOpen(!isOpen)}>
            <svg
              version="1.1"
              id="Layer_1"
