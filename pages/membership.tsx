    ...
    <>
      ...
      <div className="heading pb-12 text-center">
            ...
            <div className="membership-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-2 gap-2">
              ...
              <div className="card bg-white py-8 shadow-sm border-2 border-orange-200  hover:shadow-xl hover:border-gray-400 hover:bg-orange-300 transition-all ease-in-out">
               ...
               <div className="card bg-white py-8 shadow-sm border-2 border-blue-200  hover:shadow-xl hover:border-gray-400 hover:bg-blue-300 transition-all ease-in-out">
               ...
               <div className="card bg-white py-8 shadow-sm border-2 border-green-200  hover:shadow-xl hover:border-gray-400 hover:bg-green-300 transition-all ease-in-out">
